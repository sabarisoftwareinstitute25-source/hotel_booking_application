...
class _VillaBusinessDashboardState extends State<VillaBusinessDashboard> {
  ...
  // Updated villa types list to match property types
  ...
  void _initializeVillaData() {
    ...
    if (villaTypes.isNotEmpty) {
      ...
      // Generate sample data for different villa types
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          // Graph section with flexible height
          LayoutBuilder(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          width: 45, // Slightly wider for better text
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                for (int i = 0; i <= 4; i++)
                                  Positioned(
                                    top: (200 * i / 4), // Adjusted to match new height
                                    left: 0,
                                    right: 0,
                                    child: Container(
                                      height: 1,
  ...
  List<Widget> _getVillaTypeLabels() {
    double itemHeight = 200 / _villaTypesList.length; // Adjusted to match new graph height
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Make payment table scrollable horizontally
          SingleChildScrollView(
            scrollDirection: Axis.horizontal,
            child: Container(
              constraints: BoxConstraints(minWidth: MediaQuery.of(context).size.width - 32),
